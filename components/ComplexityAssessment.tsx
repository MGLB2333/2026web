          ...
          <div class="score-top">
            ...
            <div class="gauge-wrap">
              <svg width="200" height="200" viewBox="0 0 200 200">
                <defs>
                  <linearGradient id="gg" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#22C3ED"/><stop offset="1" stop-color="#3A2C9E"/></linearGradient>
                </defs>
...
export default function ComplexityAssessment() {
  ...
  useEffect(() => {
    ...
    function band(score) {
      if (score >= 76) return { t: 'Very high complexity', c: '#3A2C9E', bg: 'rgba(58,44,158,.12)' };
      if (score >= 55) return { t: 'High complexity', c: '#0E9AC9', bg: 'rgba(34,195,237,.14)' };
      if (score >= 30) return { t: 'Moderate complexity', c: '#0E9AC9', bg: 'rgba(34,195,237,.12)' };
