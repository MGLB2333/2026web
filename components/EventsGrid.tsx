...
const GRADS = [
  "linear-gradient(150deg,#3A2C9E,#22C3ED)",
  "linear-gradient(150deg,#0E9AC9,#1B1550)",
  "linear-gradient(150deg,#22C3ED,#2A1F78)",
  "linear-gradient(150deg,#1B1550,#0E9AC9)",
  "linear-gradient(150deg,#3A2C9E,#0E9AC9)",
];
