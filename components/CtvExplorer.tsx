...
export default function CtvExplorer() {
  ...
  useEffect(() => {
    ...
    var BADGE_COLOR = { Direct: "#3bc8ea", Curated: "#8b7cf0", Resold: "rgba(255,255,255,.35)", Exclusive: "#f5b15c" };
    function drawEdges() {
    ...
    function showDetail(id, cat) {
      ...
      var color = cat === "inv" ? "#3bc8ea" : (cat === "ssp" ? "#8b7cf0" : "#f5b15c");
          ...
          <div className="stage">
            <div className="flow-wrap" id="flowWrap">
              ...
              <div className="flow" id="flow">
                <div className="fcol" id="colInv"><div className="fcol-head"><span className="dotc" style={{ background: "#3bc8ea" }}></span> Inventory <span className="ct" id="ctInv"></span></div></div>
                <div className="fcol" id="colSsp"><div className="fcol-head"><span className="dotc" style={{ background: "#8b7cf0" }}></span> Supply (SSP) <span className="ct" id="ctSsp"></span></div></div>
